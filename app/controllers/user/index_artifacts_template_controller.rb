class User::IndexArtifactsTemplateController < ApplicationController
  ...
  def edit
    ...
    add_crumb('Search artifacts page')
  end
  ...
  def update
    ...
    if @index_artifacts_template.update_attributes(params[:index_artifacts_template])
      ...
      redirect_to edit_site_theme_index_artifacts_template_path(params[:site_theme_id])
    else
      render 'edit'
    end
  end
