Feature: Manage document types
    ...
    Scenario: friendly notice when error editing
      Given I am logged in
        ...
        | name   | description |
        | type_a | a type      |
      When I go to the edit document type page for "type_a" in "site_a"
    ...
    Scenario: friendly notice when error creating document type
      Given I am logged in
        And I have a site named "site_a"
        And I am on the document types page for "site_a"
    ...
    Scenario: create a valid document type
      Given I am logged in
        And I have a site named "site_a"
      When I go to the create document type page for "site_a"
