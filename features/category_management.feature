Feature: Manage my categories
    ...
    Scenario: friendly notice when error editing category
      Given I am logged in
        And I have a site titled "site.a"
        And "site.a" has the following categories
        | name     |
        | category_a |
      When I go to the edit category page for "category_a" in "site.a"
    ...
    Scenario: friendly notice when error creating category
      Given I am logged in
        And I have a site titled "site.a"
        And I am on the categories page for "site.a"
    ...
    Scenario: create a valid category
      Given I am logged in
        And I have a site titled "site.a"
      When I go to the create category page for "site.a"
        And I fill in "name" with "texts"
        And I press "Submit"
      Then I should see "Successfully created category"
        And I should be on the subdomain category page for "texts" in "site.a"
    ...
    Scenario: delete a category
        ...
        Then I should be on the subdomain categories page for "site.a"
