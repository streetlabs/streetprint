...
describe BrowseArtifactsTemplate do

  it "should create a new instance given valid attributes" do
    template = BrowseArtifactsTemplate.create!(Factory.attributes_for(:browse_artifacts_template))
  end
  
  it "should belong to a site_theme" do
    template = Factory(:browse_artifacts_template)
